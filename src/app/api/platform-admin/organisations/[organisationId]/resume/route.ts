...
import { resumeOrganisationSubscription } from "@/modules/platform-admin/service";
...
export async function POST(request: Request, { params }: Context) {
  try {
    ...
    return NextResponse.json(await resumeOrganisationSubscription(principal, organisationId, await request.json()));
  } catch (error) {
