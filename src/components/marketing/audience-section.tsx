    ...
    <section className="bg-white py-24 sm:py-32" id="solutions">
      <div className="mx-auto max-w-7xl px-6 sm:px-8">
        <div className="max-w-2xl">
          <p className="text-xs font-semibold tracking-[0.22em] text-navy">BUILT FOR THE ENTIRE REAL ESTATE ECOSYSTEM</p>
        ...
        <div className="mt-14 grid gap-6 lg:grid-cols-2">
          {PATHWAYS.map((pathway) => (
            <div className="scroll-mt-20 rounded-2xl border border-slate-200 bg-white p-8 shadow-sm sm:p-10" id={pathway.id} key={pathway.id}>
              <p className="text-xs font-semibold tracking-[0.22em] text-navy">{pathway.kicker}</p>
