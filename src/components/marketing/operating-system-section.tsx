...
export function OperatingSystemSection() {
  return (
    <section className="bg-slate-50 py-24 sm:py-32" id="operating-system">
      <div className="mx-auto max-w-7xl px-6 sm:px-8">
        <div className="max-w-2xl">
          ...
          <p className="mt-4 text-base leading-7 text-slate-600">
            Every part of the property business runs on the same data — not a collection of disconnected tools
        ...
        <div className="mt-14 overflow-hidden rounded-2xl border border-slate-200 bg-white">
          <div className="border-b border-slate-200 bg-slate-950 px-6 py-4">
            <p className="text-sm font-semibold tracking-tight text-white">PropertyOS</p>
          </div>
