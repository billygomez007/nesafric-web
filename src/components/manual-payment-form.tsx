...
export function ManualPaymentForm() {
  ...
  return <form className="grid gap-5 rounded-2xl border bg-white p-6 shadow-sm" onSubmit={submit}>
    ...
    <button className="rounded-lg bg-slate-950 p-3 font-semibold text-white disabled:opacity-50" disabled={saving || !selectedLease}>{saving ? "Recording..." : "Record confirmed payment"}</button>
  </form>;
}
