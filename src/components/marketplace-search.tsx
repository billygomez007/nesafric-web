...
export function MarketplaceSearch() {
  ...
  function submit(event: FormEvent<HTMLFormElement>) {
    ...
    for (const key of ["category", "providerType", "country", "region", "city", "district", "availability", "verification", "minimumRating"]) {
